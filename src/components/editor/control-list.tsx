...
function ControlMenu({ controlType }: { controlType: ItemType }) {
  ...
  return (
    <div
      style={{ zIndex: 201 }}
      className="absolute right-2.5 top-1/2 flex w-14 -translate-y-1/2 flex-col items-center rounded-lg bg-zinc-950 py-2 shadow-lg"
    >
      {
        {
          image: (
...
const TextMenuList = ({
  ...
  console.log(type, "from textMenu");
  return (
    <div className="flex flex-col items-center">
